...
export class Covid19Api extends BaseAPI {
  ...
  public apiCovid19StatesGet(state?: string, options?: any) {
    return Covid19ApiFp(this.configuration)
      .apiCovid19StatesGet(state, options)
   ...
   * @memberof Covid19Api
   */
  public apiCovid19StatesStateGet(
    state: string,
    startDate?: string,
    options?: any,
  ) {
    return Covid19ApiFp(this.configuration)
      .apiCovid19StatesStateGet(state, startDate, options)
      .then(request => request(this.axios, this.basePath))
  }
}
