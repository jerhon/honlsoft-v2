...
description: "Write a new Honlsoft blog post in this VitePress repository. Use when asked to draft or create blog posts, generate frontmatter, choose tags, structure technical writeups, or place a post in content/blog/YYYY with the correct filename format."
---
...
- `content/blog/2026/2026-03-19-my-topic.md`
- `content/blog/2025/2025-04-19-building-a-pig-latin-translating-chat-bot.md`
...
Mirror the style in `content/blog/`:
...
3. Create file in `content/blog/YYYY/YYYY-MM-DD-slug.md`.
